...
const Accessories = ({ date, logoutMssg }) => {
        ...
        <Helmet><title>Bicycle System | Accessories</title></Helmet>
            <div className="fit-container">
                <div className="flex justify-between"> 
                    <h1 className="titles">Accessories</h1>
                    <span>{date}</span>
                </div>
                ...
                <div className="h-96 overflow-y-scroll w-full bg-white rounded-md shadow-xl mt-5 p-5">
                   ...
                   { accessories.length <= 0 ? <div className="font-bold text-3xl text-center text-gray-500 mt-28"

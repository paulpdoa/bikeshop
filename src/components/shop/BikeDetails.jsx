...
const BikeDetails = ({ logoutMssg,addToCart: cartMssg,setAddToCart }) => {
    ...
    const addToCart = (e) => {
        ...
        Axios.post('/customer/cart', { inventoryId: bike.id, buyerId, transactionId: buyerId, quantity: quantity, status: status })
        .then((res) => {
    ...
    return (
        ...
        <Helmet><title>Bicycle System | {`${bike.brand_name} ${bike.item_name}`}</title></Helmet>
            <div className="flex flex-wrap justify-around max-w-7xl w-full"> 
                ...
                className="flex justify-center items-center"> { /* item image here */ }
                    <div className="w-full self-center">
                        <img className="object-cover w-96 rounded-xl ml-auto mr-auto mt-24" src={`${imageLocation}${bike.product_image}`} alt={bike.item_name} />
                        <div className="text-center mt-2"> {/*colors here */}
                            ...
                            <div className="ml-auto mr-auto flex justify-around w-16">
                                <img className="object-cover w-18 rounded-xl border-2 border-blue-400 ml-auto mr-auto px-2 py-2 cursor-pointer" src={`${imageLocation}${bike.product_image}`} alt={bike.item_name} />
                                <img className="object-cover w-18 rounded-xl border-2 border-red-400 ml-auto mr-auto px-2 py-2 cursor-pointer" src={`${imageLocation}${bike.product_image}`} alt={bike.item_name} />
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                className="px-10 py-20"> { /* information of item here */ }
                    <div className="select-none">{ /* information brand */ }
                        <h3 className="font-medium text-gray-700 text-xl">{bike.brand_name}</h3>
                        <p className="font-semibold text-gray-700 text-3xl">{bike.item_name}</p>
                    </div>
                    <div className="py-8">{ /* information price model etc.. */ }
                        <span className="font-medium text-2xl text-gray-900 select-none">₱{bike.product_price}</span>
                        ...
                        <div className="flex py-4"> {/* quantity add to cart */}
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <span onClick={() => setQuantity(quantity+1)} className={quantity < bike.quantity ? "font-semibold text-xl cursor-pointer" : 'font-semibold text-xl pointer-events-none'}>+</span>
                                </div>
                                { quantity >= bike.quantity && <span className="text-sm text-red-500 absolute mt-1">You have reached tha maximum stock</span> }
                            </div>
                            ...
                            <p className="text-gray-600 self-center text-sm">{ bike.quantity } stock/s left</p>
                        </div>
                        ...
                        <div className="bg-white shadow-xl rounded-md p-2 h-36">
                            ...
                            <div className="flex gap-10 text-gray-800">
                                ...
                                <div className="mt-2 flex flex-col">
                                    ...
                                    <span>Description: { bike.description }</span>
                                </div> 
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-2 justify-items-center w-3/4">
                                <div className="flex gap-10 self-center col-span-1">
                                    <div className="flex items-center flex-col">
                                        ...
                                        <div className="flex">
                                            <svg className="w-6 h-6" fill="yellow" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

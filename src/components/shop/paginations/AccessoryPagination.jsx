...
const AccessoryPagination = ({ totalAccessory, accessoryPerPage, paginate }) => {
    const pageNumbers = [];

    for(let i = 1; i <= Math.ceil(totalAccessory / accessoryPerPage); i++) {
        pageNumbers.push(i);
    }
...
export default AccessoryPagination
